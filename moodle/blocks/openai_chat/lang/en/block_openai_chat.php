...
$string['openai_chat'] = 'Chatbot';
$string['openai_chat:addinstance'] = 'Add a new Chatbot block';
$string['openai_chat:myaddinstance'] = 'Add a new Chatbot block to the My Moodle page';
$string['privacy:metadata'] = 'The Chatbot block stores no personal user data; nor does it, by default, send personal data to OpenAI. However, chat messages submitted by users are sent in their entirety to OpenAI, and are then subject to OpenAI\'s privacy policy (https://openai.com/api/policies/privacy/), which may store messages in order to improve the API.';
